...
public class Promotion {
    ...
    public int getCodecoupone_id() {
        return codecoupone_id;
    }

    public void setCodecoupone_id(int codecoupone_id) {
        this.codecoupone_id = codecoupone_id;
    }

    public Promotion(int id, LocalDateTime dated, LocalDateTime datef, String description, int pourcentage, int codecoupone_id) {
        this.id = id;
        this.dated = dated;
        this.datef = datef;
        this.description = description;
    ...
    public Promotion(LocalDateTime dated, LocalDateTime datef, String description, int pourcentage, int codecoupone_id) {
        this.dated = dated;
        this.datef = datef;
        this.description = description;
        this.pourcentage = pourcentage;
