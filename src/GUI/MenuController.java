...
public class MenuController implements Initializable {
    ...
    private void goTO_Front(ActionEvent event) {
                             try {
            Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("GUI/client.fxml"));
    ...
    private void goTO_back(ActionEvent event) {
            try {
            Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("GUI/HomePage.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
