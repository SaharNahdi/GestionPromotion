...
public class AjouterPromotionController implements Initializable {
     ...
     */
        ...
        CodeCouponService Cs = new CodeCouponService() ;
  ObservableList<String> options=FXCollections.observableArrayList();
             Promotion p = new Promotion ();
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        options = FXCollections.observableArrayList(Cs.getByCode());
    ...
    private void Enregister(ActionEvent event) {
        ...
        if(  dateDebut.getValue() != null
             &&   dateDebut.getValue().isBefore(LocalDate.now())
               ){
        ...
        if(  dateFin.getValue() != null
             &&   dateFin.getValue().isBefore(LocalDate.now())
               ){
            erreurs+="date must be after\n";
        } 
        if(dateFin.getValue() == null){
        ...
        Promotion p = new Promotion(dateDebut.getValue().atStartOfDay(),
                                    ...
                                    Cs.findCode(cb_coupon.getValue()).getId());
        ...
        message ="Promotion créer avec success";
        tray.setTitle(tilte);
